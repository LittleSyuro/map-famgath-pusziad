...
export const RUNDOWN_SCHEDULE_DAY_2: RundownItem[] = [
  ...
  },
  {
    ...
    title: "Daftar Doorprize & Grand Prize",
    locationName: "Area Ball Room (Panggung Utama)",
    description: "Rekapitulasi 937 Unit Doorprize & 5 Hadiah Utama Grand Prize (Sumber: DOORPRIZE HUT ZENI Update.xlsx). Terbagi atas 38 Item Grade A (90 unit) dan 101 Item Grade B (847 unit).",
    badge: "937 Unit Doorprize",
    color: "#f59e0b",
    destImage: "/doorprize/doorprize_page_1.png",
    destCoordinates: { x: 87.7, y: 29.5 },
    grandPrizes: GRAND_PRIZE_ITEMS,
    galleryImages: [
      "/doorprize/doorprize_page_1.png",
      "/doorprize/doorprize_page_2.png",
      "/doorprize/doorprize_page_3.png",
      "/doorprize/doorprize_page_4.png",
      "/doorprize/doorprize_page_5.png",
      "/doorprize/doorprize_page_6.png",
      "/doorprize/doorprize_page_7.png",
      "/doorprize/doorprize_page_8.png",
