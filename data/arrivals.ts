...
export const DAY2_HIGHLIGHT_SPOTS: HighlightSpot[] = [
  ...
  },
  {
    ...
    description: "Jembatan kaca transparan ikonik di atas lembah dengan latar belakang kemegahan Gunung Salak.",
  },
  {
    id: "spot-pinus",
...
export const RUNDOWN_SCHEDULE_DAY_1: RundownItem[] = [
  ...
  },
  {
    ...
    disablePawn: true, // Tanpa pion berjalan, langsung tampilkan visual Masjid
    galleryImages: [
